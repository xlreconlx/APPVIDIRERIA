...
public class Cotizaciondetalle  implements java.io.Serializable {
    ...
    public Cotizaciondetalle(Cotizacion cotizacion, Productos productos, String nombrepro, Integer cantidad, long precioventa, Long total, Integer preciotrabajo, Integer porcentajeganancia, String alto, String ancho, String fondo, String imgPrincipal) {
       this.cotizacion = cotizacion;
       this.productos = productos;
       this.nombrepro = nombrepro;
